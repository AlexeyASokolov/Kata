...
public class ArrrTest {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(getArrayMiddle(array3)));
        System.out.println(Arrays.toString(getArrayMiddle(array4)));
        System.out.println(Arrays.toString(getArrayMiddle(array5)));
